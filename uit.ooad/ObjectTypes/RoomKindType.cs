...
namespace uit.ooad.ObjectTypes
{
    public class RoomKindType : ObjectGraphType<RoomKind>
    {
        public RoomKindType()
        {
            ...
            Field<ListGraphType<RoomType>>("rooms", resolve: context => context.Source.Rooms.ToList(),
                                           description: "Danh sách các phòng thuộc loại phòng này");
            Field<ListGraphType<RateType>>("rates", resolve: context => context.Source.Rates.ToList(),
                                           description: "Danh sách giá cố định của loại phòng");
            Field<ListGraphType<VolatilityRateType>>("volatilityRates",
